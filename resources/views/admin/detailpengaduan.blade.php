...
<div class="container">
    <div class="row mt-3">
        <div class="col-lg-12">
            <a href="{{route('admin.detailpdf', $data_pengaduan->id)}}" class="btn btn-md btn-primary mb-4" target="_blank"><i class="fas fa-file-download mr-3"></i>Export PDF</a>
            <div class="card card-body shadow bg-dark-200 text-white">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        <form action="{{route('admin.statusOnChange', $data_pengaduan->id)}}" method="post">
                            @csrf
                        ...
                        <a href="/admin/pengaduan/{{$data_pengaduan->id}}/tanggapi" class="btn btn-primary">Tanggapi</a>
                    </div>
                </div>
            </div>

            <div class="card card-body shadow mt-3 mb-5 bg-dark-200 text-white">
                <div class="card-header">
                    <h4>Tanggapan</h4>
                </div>
                <div class="card-body">
