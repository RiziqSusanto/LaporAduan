                        ...
                        <table class="table table-bordered text-white" width="100%" id="pengaduan">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{route('petugas.detailpengaduan',$pengaduan->id)}}" class="btn btn-md btn-warning"><i class="fas fa-clipboard mr-2"></i>Detail</a>
                                        <a href="{{route('petugas.destroypengaduan',$pengaduan->id)}}" class="btn btn-md btn-danger"><i class="fas fa-trash-alt mr-2"></i>Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
